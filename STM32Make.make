...
GCC_PATH="C:/GLOBAL_VARIABLES/10 2020-Q4-MAJOR/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/GLOBAL_VARIABLES/OPENOCD-20210407/OPENOCD-20210407-0.10.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/GLOBAL_VARIABLES/OPENOCD-20210407/OPENOCD-20210407-0.10.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
